...
const repositories = [
  {
    ...
    images: [
      { tag: "latest", digest: "sha256:a1b2c3d4", size: "142MB", pushed: "2 hours ago", status: "passed" as const, critical: 0, high: 0, medium: 0 },
      { tag: "v1.4.2", digest: "sha256:a1b2c3d4", size: "142MB", pushed: "2 hours ago", status: "passed" as const, critical: 0, high: 0, medium: 0 },
      { tag: "v1.4.1", digest: "sha256:e5f6g7h8", size: "139MB", pushed: "3 days ago", status: "passed" as const, critical: 0, high: 0, medium: 2 },
    ],
  },
  {
    name: "api-gateway",
    ...
    images: [
      { tag: "latest", digest: "sha256:i9j0k1l2", size: "98MB", pushed: "5 hours ago", status: "passed" as const, critical: 0, high: 0, medium: 0 },
      { tag: "v2.1.0", digest: "sha256:i9j0k1l2", size: "98MB", pushed: "5 hours ago", status: "passed" as const, critical: 0, high: 0, medium: 0 },
    ],
  },
  {
    name: "user-service",
    ...
    images: [
      { tag: "latest", digest: "sha256:m3n4o5p6", size: "112MB", pushed: "1 day ago", status: "warning" as const, critical: 0, high: 1, medium: 0 },
      { tag: "v3.0.1", digest: "sha256:m3n4o5p6", size: "112MB", pushed: "1 day ago", status: "warning" as const, critical: 0, high: 1, medium: 0 },
      { tag: "v3.0.0", digest: "sha256:q7r8s9t0", size: "110MB", pushed: "4 days ago", status: "passed" as const, critical: 0, high: 0, medium: 0 },
      { tag: "v2.9.8", digest: "sha256:u1v2w3x4", size: "108MB", pushed: "1 week ago", status: "passed" as const, critical: 0, high: 0, medium: 0 },
    ],
  },
];
    ...
    <Shell>
      <div className="space-y-8">
        <div className="flex items-center justify-between">
          ...
          <button className="inline-flex items-center gap-2 rounded-lg bg-accent-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-accent-600">
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          <StatCard label="Total Images" value="9 tags" />
          <StatCard label="Total Size" value="1.06 GB" />
          <StatCard label="Scan Status" value="8 passed" sub="1 warning" />
        </div>
