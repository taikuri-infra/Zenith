    ...
    if (err) {
      ...
      setError(
        err === "oauth_failed"
          ...
          : err === "not_admin"
          ? "Access denied. Only platform administrators can sign in."
          : err
      );
    }
  }, [router, searchParams]);
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8">
          ...
          <p className="text-sm text-neutral-400 mb-6">
            Only invited administrators can access Mission Control.
          </p>
          ...
          {/* Google Sign In */}
          <a
            href={api.auth.getGoogleOAuthUrl()}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white hover:bg-neutral-100 rounded-lg text-neutral-900 font-medium transition-colors"
          >
        ...
        <p className="mt-6 text-center text-xs text-neutral-600">
          ...
          <br />
          Contact your admin to get an invitation.
        </p>
      </div>
    </div>
  );
