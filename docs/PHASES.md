...
P0-04  Create Dockerfile for zenith-operator (multi-stage Go build)
P0-05  Create Dockerfile for zenith-api (multi-stage Go build)
...
```
P2-01  Create Go API server skeleton (cmd/zenith-api/main.go)
...
## Phase 3: CRDs + Zenith Operator Foundation (Week 6-7)
...
P3-38  Implement ProjectController:
         - Watch Project CRD
         - Create K8s namespace (zenith-{project-name})
...
### Operators Installed
```
(none yet - Zenith operator only)
```

### Definition of Done
- [ ] All 25 CRDs defined and installable
- [ ] Zenith Operator runs and Project controller works
...
P10-07  Implement SAML 2.0 Identity Provider integration:
          ...
          - Zenith configures Keycloak SAML IDP automatically
...
P10-08  Implement OIDC Identity Provider integration:
          ...
          - Zenith configures Keycloak OIDC IDP automatically
