...
│  [Floating IPs] [VPN] [API Gateway] [Cloud Connections]    │
│  ─────────────────────────────────────────────────────────  │
```
...
### 8. Auth (Keycloak Simplified)

```
│  Auth                                                      │
│                                                             │
│  [Users] [Roles] [SSO Providers] [API Keys]                │
│  ─────────────────────────────────────────────────────────  │
│                                                             │
│  Users                                    [+ Invite User]   │
│                                                             │
...
│  │  admin@startup.com   Admin       🟢 Active  2h ago   │  │
│  │  dev@startup.com     Developer   🟢 Active  1d ago   │  │
│  │  view@startup.com    Viewer      ⚪ Invited  never   │  │
│  └──────────────────────────────────────────────────────┘  │
│                                                             │
│  SSO Providers                                             │
│  ┌──────────────────────────────────────────────────────┐  │
...
│  │  SAML/OIDC  ⚪ Not configured [Configure]             │  │
│  └──────────────────────────────────────────────────────┘  │
│                                                             │
│  API Keys                                [+ Create Key]     │
│  ┌──────────────────────────────────────────────────────┐  │
│  │  deploy-key    zen_sk_...xxxxx    Created 5d ago     │  │
│  │  ci-key        zen_sk_...yyyyy    Created 2w ago     │  │
│  └──────────────────────────────────────────────────────┘  │
```
...
│  Container Registry                                        │
│                                                             │
│  Registry URL: registry.your-cluster.com                   │
│                                                             │
│  Images                                                    │
│  ┌──────────────────────────────────────────────────────┐  │
│  │  frontend          3 tags    Last push: 2 min ago    │  │
│  │    latest, v23, v22                                  │  │
│  ├──────────────────────────────────────────────────────┤  │
│  │  user-service      5 tags    Last push: 3 hours ago  │  │
│  │    latest, v12, v11, v10, v9                         │  │
│  ├──────────────────────────────────────────────────────┤  │
│  │  api-gateway       2 tags    Last push: 1 day ago    │  │
│  │    latest, v45                                       │  │
│  └──────────────────────────────────────────────────────┘  │
│                                                             │
│  Push Instructions                                         │
│  ┌──────────────────────────────────────────────────────┐  │
│  │  docker login registry.your-cluster.com              │  │
│  │  docker tag my-app registry.your-cluster.com/my-app  │  │
│  │  docker push registry.your-cluster.com/my-app        │  │
│  └──────────────────────────────────────────────────────┘  │
```
...
│  │  🌍 Planets (3)                                      │  │
│  │  ┌────────────────────────────────────────────────┐  │  │
│  │  │ galaxy-cp-1   CX33 (4v, 8GB)   fsn1   🟢     │  │  │
│  │  │ galaxy-cp-2   CX33 (4v, 8GB)   fsn1   🟢     │  │  │
│  │  │ galaxy-cp-3   CX33 (4v, 8GB)   fsn1   🟢     │  │  │
│  │  └────────────────────────────────────────────────┘  │  │
│  │                                                      │  │
│  │  🔐 Auth                                             │  │
│  │  ┌────────────────────────────────────────────────┐  │  │
...
│                                                             │
│  ┌──────────────────────────────────────────────────────┐  │
│  │  🌍 galaxy-cp-1        CX33 (4 vCPU, 8GB)           │  │
│  │     Status: 🟢 Ready   Region: fsn1                  │  │
│  │     CPU: ████████░░ 78%   RAM: ██████████░ 91%       │  │
│  │     Pods: 12/25            Uptime: 14 days            │  │
│  │     Role: Control Plane                               │  │
│  ├──────────────────────────────────────────────────────┤  │
│  │  🌍 galaxy-cp-2        CX33 (4 vCPU, 8GB)           │  │
│  │     Status: 🟢 Ready   Region: fsn1                  │  │
│  │     CPU: ██████░░░░ 55%   RAM: █████████░░ 85%       │  │
│  │     Pods: 10/25            Uptime: 14 days            │  │
│  │     Role: Control Plane                               │  │
│  ├──────────────────────────────────────────────────────┤  │
│  │  🌍 galaxy-cp-3        CX33 (4 vCPU, 8GB)           │  │
│  │     Status: 🟢 Ready   Region: fsn1                  │  │
│  │     CPU: █████░░░░░ 45%   RAM: ████████░░░ 72%       │  │
...
Implementation: WebSocket from frontend → Galaxy API → kubectl logs/watch
```
