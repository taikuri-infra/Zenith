...
> One €5 server manages everything. CAPI upgrades clusters. Mission Control is the control panel.
...
### Mission Control - The Platform Operator Panel

**URL:** `ms.freezenith.com` (or self-hosted: `ms.your-domain.com`)
...
│     Admin panel:   https://ms.myplatform.com (you are here)    │
│                                                                  │
│     What's next:                                                 │
...
├── zenith-mc/main.go                # Mission Control API
├── mission-control/             # Platform operator frontend
└── zen/main.go                  # CLI
...
apps/mission-control/                         # Mission Control frontend (Next.js)
├── src/app/
│   ├── page.tsx                 # Dashboard
│   ├── clusters/
│   ├── modules/
